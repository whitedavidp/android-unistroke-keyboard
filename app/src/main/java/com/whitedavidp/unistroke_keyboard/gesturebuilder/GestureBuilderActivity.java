...
public class GestureBuilderActivity extends ListActivity {
    ...
    {
      super.onStart();
      App.log("GestureBuilder", "in onStart");
      setupLibrary(getIntent());
    }
      
    private void setupLibrary(Intent intent)
    {
      String fileName = intent.getStringExtra(App.GESTURE_BUILDER_FILE_NAME);
      App.log("GestureBuilder", "passed filename: " + fileName);
      if(null != fileName)
      {
      ...
      {
        App.showToast(getString(R.string.bad_gesture_file));
      }
    ...
    public void testGestures(View v) {
      if(App.getShowOnTestReminder())
      {
        startTest();
        return;
      }
      
      String message = "\n" + getResources().getString(R.string.test_gesture_instructions) + "\n";
      
      AlertDialog.Builder builder = new AlertDialog.Builder(this);
      builder.setMessage(message);
      builder.setTitle(getString(R.string.button_test));
      final CheckBox chkDontRemindAgain = new CheckBox(GestureBuilderActivity.this);
      ...
      builder.setPositiveButton(getString(R.string.ok), new DialogInterface.OnClickListener() 
      {
        ...
        {
          App.setShowOnTestReminder(chkDontRemindAgain.isChecked());
          startTest();
        }
      });
    ...
    private void startTest()
    {
      ...
      intent.putExtra(App.GESTURE_BUILDER_FILE_NAME, mStoreFileName);
      startActivityForResult(intent, REQUEST_NEW_GESTURE);      
    }
...
out:        for (String name : entries) {
    ...
    private class GesturesLoadTask extends AsyncTask<Void, NamedGesture, Integer> {
        ...
        protected Integer doInBackground(Void... params) {
            ...
            App.preGestureLibraryLoad(store);
